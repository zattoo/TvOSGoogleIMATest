...
extension ErrorModel: DTOConvertible {
    
    var DTO: Error {
        return Error(code: code.DTO, localizedDescriptions: localizedDescriptions)
    }
}

extension ErrorCodeModel: DTOConvertible {
